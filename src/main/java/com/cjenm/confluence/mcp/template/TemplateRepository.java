...
public class TemplateRepository {
    ...
    public TemplateRepository() {
        this.templates = initTemplates().stream()
    ...
    private List<Template> initTemplates() {
        return List.of(
                new Template("basic-doc", "기본 문서",
                        "제목, 단락, 리스트, 코드 블록이 포함된 기본 문서 구조",
                        """
                        # 문서 제목
                ...
                new Template("api-doc", "API 문서",
                        "REST API 엔드포인트 문서 템플릿",
                        """
                        # User API
                ...
                new Template("meeting-note", "회의록",
                        "회의 내용, 결정 사항, 액션 아이템 기록용",
                        """
                        # 주간 개발 회의록
